			...
			<div class="grid-body">
				<form role="form" class="form-horizontal" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select class="form-control" name="kelas" required>
								<option>Kelas X (Sepuluh)</option>
								<option>Kelas XI (Sebelas)</option>
								<option>Kelas XII (Duabelas)</option>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="password" value="<?php echo $row['password']; ?>" placeholder="Ubah Password" required>
						</div>
					</div>
					<hr/>
					<div class="form-group">
